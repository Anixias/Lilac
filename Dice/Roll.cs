...
public abstract class Roll
{
	...
	public sealed class Modifier : Roll
	{
		...
		public override IRollResult Execute() => new GenericRollResult(Value);
		public override (IRollResult, IRollResult) Range() => (Execute(), Execute());
		public override (IRollResult, IRollResult) BaseRange() => (new GenericRollResult(0), new GenericRollResult(0));
	...
	public sealed class Die : Roll
	{
		...
		public override (IRollResult, IRollResult) BaseRange() => Range();
	...
	public sealed class Multiple : Roll
	{
		...
		public override string ToString() => $"{Count}{BaseDie}";
	}

	/// <summary>A set of dice with the same side count that can be rolled collectively, keeping the specified number of highest rolls.</summary>
	public sealed class KeepHighest : Roll
	{
		...
		public override (IRollResult, IRollResult) BaseRange() => Range();
		public override string ToString() => $"{Count}{BaseDie}kh{Keep}";
	}

	/// <summary>A set of dice with the same side count that can be rolled collectively, keeping the specified number of lowest rolls.</summary>
	public sealed class KeepLowest : Roll
	{
		...
		public override (IRollResult, IRollResult) BaseRange() => Range();
		public override string ToString() => $"{Count}{BaseDie}kl{Keep}";
	}
